...
var {BoundField, CheckboxFieldRenderer, Form, RadioFieldRenderer} = require('newforms')
...
var BootstrapField = React.createClass({
  ...
  render() {
    ...
    , 'has-success': status == 'valid'
      ...
      {field.labelTag({attrs: {className: 'control-label'}})}
      {field.asWidget({attrs: {className: 'form-control'}})}
      {showHelpText && <span className="help-block">{field.helpText}</span>}
...
BootstrapForm.components = {BootstrapField}
BootstrapForm.renderers = {CheckboxInlineRenderer, RadioInlineRenderer}
