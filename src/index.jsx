...
var BootstrapForm = React.createClass({
  ...
  renderRows() {
    ...
    rows.push.apply(rows, form.visibleFields().map(field =>
      <BootstrapField key={field.htmlName} field={field} spinner={this.props.spinner} errorClasses={this.props.errorClasses}/>
    ))
...
var BootstrapField = React.createClass({
  ...
  render() {
    ...
    return <div className={containerClasses}>
      ...
      {status == 'error' && field.errors().messages().map(value => errorMessage(value,errorClasses))}
    </div>
  }
})
